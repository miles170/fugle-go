		...
		Data: QuoteData{
			...
			Quote: Quote{
				...
				Order: Order{
					At: time.Date(2022, 8, 19, 13, 30, 0, 0, location),
					Bids: []BidAsk{
						{Price: decimal.NewFromInt(519), Volume: 53},
						{Price: decimal.NewFromInt(518), Volume: 602},
						{Price: decimal.NewFromInt(517), Volume: 808},
						{Price: decimal.NewFromInt(516), Volume: 429},
						{Price: decimal.NewFromInt(515), Volume: 722},
					},
					Asks: []BidAsk{
						{Price: decimal.NewFromInt(520), Volume: 16},
						{Price: decimal.NewFromInt(521), Volume: 314},
						{Price: decimal.NewFromInt(522), Volume: 498},
						{Price: decimal.NewFromInt(523), Volume: 1131},
						{Price: decimal.NewFromInt(524), Volume: 432},
					},
				},
				PriceHigh: Price{
				...
				PriceAverage: Price{
					At:    time.Date(2022, 8, 19, 13, 30, 0, 0, location),
					Price: decimal.NewFromFloat(520.06),
				},
		...
		Data: QuoteData{
			...
			Quote: Quote{
				...
				PriceHigh: Price{
					...
					Price: decimal.NewFromFloat(15458.45),
				},
				PriceLow: Price{
					At:    time.Date(2022, 8, 19, 9, 35, 45, 0, location),
					Price: decimal.NewFromFloat(15346.26),
				},
				PriceOpen: Price{
					At:    time.Date(2022, 8, 19, 9, 0, 5, 0, location),
					Price: decimal.NewFromFloat(15394.36),
				},
				Trade: Trade{
					At:     time.Date(2022, 8, 19, 13, 30, 0, 0, location),
